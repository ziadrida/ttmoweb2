...
async function updatePurchaseOrder(root, args, context) {

  console.log("=> in updatePurchaseOrder args:",args)
  //console.log('root:', root)
//  console.log('args:', args)
  //console.log('context:', context)

  //if (debugOn) console.log("=> in updatePurchaseOrder:", JSON.stringify(args.input));
