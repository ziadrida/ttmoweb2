...
import ColumnChooser from './column-chooser.js';
import mouseOverPopper from './mouse-over-popper.js';
// import _ from './utils'
...
class CustomPagination extends Component {
  ...
  render() {
    // props passed by ReactTable in order-details
    var {
      // Computed
      pages,
      classes,
    ...
    return (
      <div className={classes1(className, '-pagination')} style={this.props.style}>
        ...
        <ColumnChooser columns={views} onColumnUpdate={onViewUpdate} />
